...
export default function SafetySection() {
  return (
    <div className="relative py-20 md:py-16 px-4 bg-gradient-to-br from-white via-emerald-50/30 to-teal-50/30 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
          ...
          <div className="order-2 lg:order-1">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-emerald-200 to-teal-200 rounded-[3rem] blur-2xl opacity-30"></div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg border-l-4 border-teal-500 hover:shadow-xl transition-shadow">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-teal-500 to-emerald-500 rounded-xl flex items-center justify-center flex-shrink-0 shadow-md">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="group relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-emerald-200">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-xl flex items-center justify-center flex-shrink-0 text-white font-bold shadow-md group-hover:scale-110 transition-transform">
                    1
                  </div>
                  <div>
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-emerald-300 to-teal-300 rounded-[3rem] blur-2xl opacity-20"></div>
              <div className="relative bg-gradient-to-br from-emerald-50 to-teal-50 rounded-[3rem] p-8  border border-emerald-100">
                <div className="relative h-[350px] md:h-[400px] flex items-center justify-center">
                  <Image
