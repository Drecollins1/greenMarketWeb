...
import { Heart, MessageCircle, Bookmark, Share2, Image, Smile, MapPin, Users, Calendar, ChevronRight, ThumbsUp, Send, Settings, User, Shield, Bell, Edit3, Trash2, Plus, Search } from 'lucide-react';
...
const CommunityFeed: React.FC = () => {
  ...
  const [settingsSubTab, setSettingsSubTab] = useState<'General' | 'Members' | 'Moderation' | 'Notifications'>('General');
  ...
  const events: Event[] = [
    {
      ...
      icon: '🌾',
      description: 'Join us for the premier agricultural exhibition featuring livestock innovations and networking opportunities.',
      attendees: 1500,
      isJoined: false
    },
    {
      ...
      icon: '🏢',
      description: 'Virtual connect for sustainable farming practices and market linkages.',
      attendees: 307,
      isJoined: true
    },
    {
      ...
      location: 'Lagos State Event Center',
      icon: '🎵',
      description: 'Explore fintech solutions tailored for agricultural financing and trade.',
      attendees: 800,
      isJoined: false
    },
    {
      ...
      icon: '🚜',
      description: 'Annual expo for farm inputs, machinery, and direct market access.',
      attendees: 437,
      isJoined: false
    }
  ];
  ...
  const members: Member[] = [
    { id: '1', name: 'Michael Brown', role: 'Member', avatar: '', joined: '2 months ago', email: 'michael@example.com' },
    { id: '2', name: 'Adeline Enterprise', role: 'Member', avatar: '', joined: '6 months ago', email: 'adeline@example.com' },
    { id: '3', name: 'Olajuwon Francis', role: 'Admin', avatar: '', joined: '1 year ago', email: 'olajuwon@example.com' },
    { id: '4', name: 'Michael Bosch', role: 'Moderator', avatar: '', joined: '8 months ago', email: 'bosch@example.com' },
    { id: '5', name: 'Alice Oyekan', role: 'Member', avatar: '', joined: '3 months ago', email: 'alice@example.com' },
    { id: '6', name: 'Greg Koski', role: 'Member', avatar: '', joined: '1 month ago', email: 'greg@example.com' }
  ];
      ...
      comments: [
        {
          ...
          replies: [
            ...
            },
            {
              ...
              timestamp: '4 days ago',
              content: 'I think cooperating buying can help. If farmers in one area come together, we can buy food in bulk at lower prices.',
              replies: [
                {
                  id: '1-2-1',
                  author: 'Michael Bosch',
                  timestamp: '4 days ago',
                  content: 'No good plan is, but sometimes farmers no dey trust each other with money. If we fit get one person to coordinate well, e go make sense.',
                  replies: [],
                  parentId: '1-2'
                }
              ],
        ...
        },
        {
          ...
          content: 'In my area, we use brewery waste (spent grain) as an affordable supplement for cattle feed. It is cheap and nutritious.',
          replies: []
        },
        {
          id: '3',
        ...
        },
        {
          ...
          content: 'Maybe breweries/beer can even create a cooperative group forum. If farmers join by location, the platform can help organize bulk orders and make payments easier.',
          reactions: { thumbs: 2 },
          replies: []
        },
        {
  ...
  const renderComments = (comments: Comment[], isNested = false) => {
    return comments.map((comment) => (
      <div key={comment.id} className={isNested ? 'ml-4 sm:ml-8 md:ml-10 mt-3' : 'mt-4'}>
      ...
      {posts.map((post) => (
        <div key={post.id} className="bg-white rounded-lg shadow-sm mb-6">
          ...
          <div className="px-4 py-2 flex items-center justify-between text-sm text-gray-500 border-t border-gray-100">
            <span>{post.likes} Likes · {post.comments.reduce((acc, c) => acc + 1 + c.replies.length, 0)} comments</span>
          </div>
          {/* Post Actions */}
  ...
  const renderPeopleTab = () => (
    <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6">
      ...
      <div className="space-y-4">
        {members.map((member) => (
          <div key={member.id} className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-3 border-b border-gray-100 last:border-b-0 gap-3 sm:gap-0">
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-700">
            Welcome to the Livestock & Poultry Network - a community dedicated to sharing knowledge, best practices,
            and innovative solutions for livestock and poultry farming. Connect with farmers, experts, and suppliers
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-700">
            ...
            <li className="flex items-center justify-between py-3 border-b border-gray-100">
              <span className="text-sm text-gray-700">Support fellow farmers and contribute positively</span>
            ...
            <div className="pt-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input type="text" defaultValue="Livestock & Poultry Network" className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500" />
                </div>
                <div>
            ...
            <div className="pt-6">
              ...
              <div className="space-y-4">
                {filteredMembers.map((member) => (
                  <div key={member.id} className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-3 border-b border-gray-100 gap-3 sm:gap-0">
                    <div className="flex items-center space-x-3 w-full sm:w-auto">
              ...
              {selectedMember && (
                <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                  ...
                  <button onClick={() => setSelectedMember(null)} className="text-gray-600 underline">Close</button>
                </div>
              )}
            </div>
          )}
            ...
            <div className="pt-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <label htmlFor="auto-moderate" className="text-sm text-gray-700">Enable auto-moderation for spam</label>
                </div>
                <div className="flex items-center space-x-3">
                  <input type="checkbox" id="report-notifs" className="rounded" />
                  <label htmlFor="report-notifs" className="text-sm text-gray-700">Notify admins on new reports</label>
                </div>
            ...
            <div className="pt-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between py-3 border-b border-gray-100">
                  <span className="text-sm text-gray-700">New post notifications</span>
                  <input type="checkbox" className="rounded" />
                </div>
                <div className="flex items-center justify-between py-3 border-b border-gray-100">
                  <span className="text-sm text-gray-700">Member join alerts</span>
                  <input type="checkbox" className="rounded" />
                </div>
                <div className="flex items-center justify-between py-3 border-b border-gray-100">
        ...
        <div className="p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div className="flex items-center space-x-4 w-full sm:w-auto">
              ...
              <div className="min-w-0 flex-1">
                <h1 className="text-2xl font-bold text-gray-900 truncate">Livestock & Poultry Network</h1>
            ...
            {mainSection === 'Events' && (
              <div className="bg-white rounded-lg shadow-sm p-4">
                ...
                <div className="space-y-3">
                  {events.map((event) => (
                    <div key={event.id} className="flex items-center space-x-3 py-2 cursor-pointer hover:bg-gray-50 rounded">
